...
def analyze_resume():
    ...
    try:
        ...
        client = genai.Client(api_key="AIzaSyBWnQZClY_HusSiAzxcrGbRK008IiACiJA")
            ...
            types.Content(
                ...
                parts=[
                    ...
                    types.Part.from_text(
                        text="""Analyze the given resume in detail and provide structured feedback. Start with precise formatting feedback, covering aspects such as font consistency, section ordering, and overall readability. Then, provide section-wise suggestions interactively, ensuring that each part of the resume is improved step by step. Finally, suggest skill enhancements and learning paths based on the user's career objective (e.g., aspiring ML Engineer)."""
                    ),
                ],
            )]
